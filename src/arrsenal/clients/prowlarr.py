...
Position du projet : arrsenal ne fournit, n'heberge et ne recommande AUCUN
indexeur. La liste proposee ici est celle que votre propre Prowlarr embarque
(626 definitions en 2.5.2) ; arrsenal n'est qu'une interface de saisie par-dessus.
...
class ProwlarrIndexers:
    ...
    def find(self, name: str) -> IndexerDefinition:
        ...
        raise WiringError(
            ...
            "utilisez `arrsenal indexers search <terme>` pour trouver le nom exact",
        )
    ...
    def add(self, definition: IndexerDefinition, values: dict[str, str]) -> tuple[bool, str]:
        ...
        comportement, pas un choix d'arrsenal, et `forceSave` n'y change rien.
        """
